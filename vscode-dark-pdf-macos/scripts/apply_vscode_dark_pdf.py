...
def main() -> int:
    ...
    print("If you use LaTeX Workshop's default Build action, SyncTeX is normally already enabled.")
    print("If you use custom tools, recipes, or an external build script, keep -synctex=1 on every run.")
