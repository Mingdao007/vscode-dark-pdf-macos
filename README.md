...
A `Codex App` skill for configuring macOS Visual Studio Code for dark PDF viewing with LaTeX Workshop, right-side PDF tabs, source wrap, and optional LaTeX squiggle suppression.
...
- `vscode-dark-pdf-macos/scripts/apply_vscode_dark_pdf.py`: helper script for applying the baseline VS Code settings
...
- troubleshoot white PDF rendering and `vscode-pdf` extension conflicts
